...
Route::group(['as' => $as, 'middleware' => ['auth', 'permission:ADMIN_PANEL']], function () {
    ...
    Route::get(config('laraadmin.adminRoute') . '/subjects/getsubject/{id}', 'LA\SubjectsController@getsubject');
	...
	/* ================== Certifs ================== */
	Route::resource(config('laraadmin.adminRoute') . '/certifs', 'LA\CertifsController');
	Route::get(config('laraadmin.adminRoute') . '/certif_dt_ajax', 'LA\CertifsController@dtajax');

	/* ================== passCertif ================== */
	Route::resource(config('laraadmin.adminRoute') . '/passCertif', 'passCertif');
    Route::get(config('laraadmin.adminRoute') . '/passCertif/getsubject/{id}', 'passCertif@getsubject');
    /*======================================================*/

    Route::get(config('laraadmin.adminRoute') . '/qst/excel',array('as'=>'excel.import','uses'=>'LA\QuestionsController@excel'));
    Route::post(config('laraadmin.adminRoute') . '/qst/import-csv-excel',array('as'=>'import-csv-excel','uses'=>'LA\QuestionsController@importFileIntoDB'));
    Route::get(config('laraadmin.adminRoute') . '/qst/download-excel-file/{type}', array('as'=>'excel-file','uses'=>'LA\QuestionsController@downloadExcelFile'));
    Route::get(config('laraadmin.adminRoute') . '/qst/model-excel-file/{type}', array('as'=>'excel-file-model','uses'=>'LA\QuestionsController@modelExcelFile'));
